...
import { isEmail, clean, required, getIp, json } from "@/lib/validate";
...
export const POST: APIRoute = async ({ request }) => {
  ...
  await notify("Yeni ANALİZ başvurusu — mepackage", {
